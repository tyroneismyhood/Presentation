  ...
  Render.nextFrame(function () {
    ...
    for (var e in c) {
      if (typeof b[e] === "undefined") {
        ...
        if (typeof b[e] != d) {
          throw (
            "Interface Error: Property " + e + " is Incorrect Type ::: " + a
          );
        }
      }
    }
...
Class(function View(a) {
  Inherit(this, MVC);
  this.element = $(
    "." + a.constructor.toString().match(/function ([^\(]+)/)[1]
  );
...
Class(function Utils() {
  ...
  function a(e) {
    ...
    return (
      "0123456789ABCDEF".charAt((e - (e % 16)) / 16) +
...
(function () {
  ...
  $.fn.mask = function (b, a, e, c, d) {
    this.div.style[Device.styles.vendor + "Mask"] =
      (b.strpos(".") ? "url(" + b + ")" : b) + " no-repeat";
    return this;
  };
  $.fn.css = function (d, c) {
    if (typeof c == "boolean") {
...
Class(function CSS() {
  ...
  this.prefix = function (h) {
    return Device.styles.vendor == ""
      ? h[0].toLowerCase() + h.slice(1)
      : Device.styles.vendor + h;
  };
}, "Static");
Class(function Device() {
  ...
  this.system.webaudio =
    typeof window.webkitAudioContext !== "undefined" ||
    typeof window.AudioContent !== "undefined";
  this.system.localStorage = typeof window.localStorage !== "undefined";
  this.system.fullscreen =
    typeof document[b.vendor + "CancelFullScreen"] !== "undefined";
  ...
  this.styles.vendorTransition = this.styles.vendor.length
    ? this.styles.vendor + "Transition"
    : "transition";
  this.styles.vendorTransform = this.styles.vendor.length
    ? this.styles.vendor + "Transform"
    : "transform";
  ...
  function b(i, j, f) {
    ...
    if (arguments.length > 1 && (j === null || typeof j !== "object")) {
      ...
      return (document.cookie = [
        ...
        "=",
        g.raw ? String(j) : encodeURIComponent(String(j)),
...
Class(function PushState(a) {
  ...
  if (typeof a !== "boolean") {
    a =
      window.location.href.strpos("local") ||
      window.location.href.charAt(0) == "1";
  }
  this.locked = false;
  ...
  if (Device.mobile) {
    ...
    function g(l) {
      ...
      if (h.target) {
        var k = h.target;
        var j =
          k.__scrollHeight || Number((k.style.height || "0px").slice(0, -2));
        k.__scrollheight = j;
        if (m.y < h.y) {
...
Class(function CSSAnimation(a) {
  ...
  this.set("ease", function (o) {
    b = o;
    if (i.playing && a) {
      a.div.style[CSS.prefix("AnimationTimingFunction")] =
        TweenManager.getEase(b);
    }
  });
  ...
  this.play = function () {
    ...
    a.div.style[CSS.prefix("AnimationDuration")] = i.duration + "ms";
    a.div.style[CSS.prefix("AnimationTimingFunction")] = n
      ? "steps(" + n + ")"
      : TweenManager.getEase(b);
    a.div.style[CSS.prefix("AnimationIterationCount")] = e ? "infinite" : k;
...
Class(function Warp(i) {
  ...
  function c(k, l) {
    return [
      k[0] * l[0] + k[1] * l[1] + k[2] * l[2],
      k[3] * l[0] + k[4] * l[1] + k[5] * l[2],
      k[6] * l[0] + k[7] * l[1] + k[8] * l[2],
    ];
  }
...
Class(function Canvas(c, e, j) {
  ...
  function k() {
    ...
    g.background =
      "-" + Device.styles.vendor.toLowerCase() + "-canvas(" + o + ")";
    j.css({
...
Class(function CanvasObject() {
  ...
  this.updateValues = function () {
    this.anchor.tx =
      this.anchor.x <= 1 && !this.anchor.full
        ? this.anchor.x * this.width
        : this.anchor.x;
    this.anchor.ty =
      this.anchor.y <= 1 && !this.anchor.full
        ? this.anchor.y * this.height
        : this.anchor.y;
    this.values.setTRSA(
      this.x,
      this.y,
      Utils.toRadians(this.rotation),
...
Class(function CSSShader(l, f, k) {
  ...
  this.tween = function (o, p, q, n, r) {
    ...
    a = setTimeout(function () {
      l.div.style[Device.styles.vendor + "Transition"] =
        "all " + p + "ms " + TweenManager.getEase(q) + " " + n + "ms";
      var u = {};
      var s = {};
      var v = {};
      for (var t in o) {
...
Class(function GLShader(z, r, c, f, t) {
  ...
  function y() {
    ...
    f = [
      ...
      "}",
      "vec2 coord(vec2 pos) {",
      "return pos / u_resolution;",
      "}",
      "vec2 pixel(vec2 co) {",
      "return co * u_resolution;",
      "}",
      "void main() {",
      "position = vec4(_position(a_position), 0, 1);",
      "v_texCoord = a_texCoord;",
      A || "",
      A && A.strpos("gl_Position") ? "" : "gl_Position = position;",
      "}",
    ].join("");
    if (B) {
    ...
    t = [
      ...
      "}",
      "void main() {",
      "texel = texture2D(u_texture, v_texCoord);",
      A || "",
      A && A.strpos("gl_FragColor") ? "" : "gl_FragColor = texel;",
      "}",
    ].join("");
  }
...
(function () {
  ...
  TweenManager.MathEasing.Elastic = {
    ...
    Out: function (c) {
      ...
      return (
        b * Math.pow(2, -10 * c) * Math.sin(((c - d) * (2 * Math.PI)) / e) + 1
      );
    },
  ...
  $.fn.click = function (d, a) {
    ...
    if (a) {
      if (this._events.click) {
        this.div[Hydra.removeEvent](
          Hydra.translateEvent("click"),
          this._events.click,
          true
        );
  ...
  $.fn.hover = function (g, a) {
    ...
    if (a) {
      if (this._events.hover) {
        this.div[Hydra.removeEvent](
          Hydra.translateEvent("mouseover"),
          this._events.hover,
          true
        );
        this.div[Hydra.removeEvent](
          Hydra.translateEvent("mouseout"),
          this._events.hover,
          true
        );
  ...
  $.fn.press = function (d, a) {
    ...
    if (a) {
      if (this._events.press) {
        this.div[Hydra.removeEvent](
          Hydra.translateEvent("mousedown"),
          this._events.press,
          true
        );
        this.div[Hydra.removeEvent](
          Hydra.translateEvent("mouseup"),
          this._events.press,
          true
        );
  ...
  this.Presentation = [
    {
      setup: "Introduction",
      punchline:
        "The New England Region was made up from colonies of Massachusetts Bay, New Hampshire, Rhode Island and Connecticut.",
      order: 1,
      fontsize: 100,
    },
    {
      setup: "Introduction Part 2",
      punchline:
        "The New England Region had rocky soil, dense forests, and natural harbors which gave easy access to the sea. The New England Region was made up from two religious groups within the Puritan religion.",
      order: 2,
      fontsize: 100,
    },
    {
      setup: "Introduction Part 3",
      punchline:
        "The two groups that were from the Puritan religion consisted of two different sections of Puritanism.",
      order: 3,
      fontsize: 100,
    },
    {
      setup: "Economy",
      punchline:
        "Our economy is largely dependent on the ocean. Fishing is most important to the new England economy. What was also important to the new England economy was whaling, trapping, shipbuilding, and logging.",
      order: 4,
      fontsize: 20,
    },
    {
      setup: "Economy Part 2",
      punchline:
        "Other parts of our economy was developed base on every colony’s environment. The reason why our economy is largely dependant on the ocean is because, our colonies have very rocky soil which wasn’t suitable for plantation farming.",
      order: 5,
      fontsize: 20,
    },
    {
      setup: "Climate",
      punchline:
        "To start off there are a few advantages, and disadvantages with the climate. One advantage of the cold weather in the New England Region was that it limited the spread of certain diseases.",
      order: 6,
      fontsize: 20,
    },
    {
      setup: "Climate Part 2",
      punchline:
        "Although one of the disadvantages with the cold weather is that it shortened the growing season to about five months which is why most people rely on fishing, etc to make money.",
      order: 7,
      fontsize: 20,
    },
    {
      setup: "History",
      punchline:
        "For some little background information, New England is one of the most historic regions in the USA. The region was one of the earliest English settlements in the “New World” following the arrival of the Pilgrims, who set sail from England on the Mayflower in 1620 in search of freedom.",
      order: 8,
      fontsize: 20,
    },
    {
      setup: "New England Region Facts",
      punchline:
        "To start off, the first settlers were actually the Pilgrims. Secondly, New England's Region played a important role in the singing of the Declaration of Independence. Secondly, our region is built from 4 colonies, Massachusetts Bay, New Hampshire, Rhode Island, and Connecticut.",
      order: 9,
      fontsize: 20,
    },
    {
      setup: "New England Region Facts Part 2",
      punchline:
        " The Massachusetts Bay colony was founded in 1620 by pilgrims from the Mayflower, New Hampshire was founded in 1622 by John Mason, Rhode Island was founded in 1636 by Roger Williams.",
      order: 10,
      fontsize: 20,
    },
    {
      setup: "New England Region Facts Part 3",
      punchline:
        "Anne Hutchinson, and Connecticut was founded in 1633 but it was originally under Dutch control but the colony was taken over by Reverend Thomas Hooker and a group of puritans from the Massachusetts Bay colony.",
      order: 11,
      fontsize: 20,
    },
    {
      setup: "Conclusion",
      punchline:
        "To sum it all up, The New England Region was a place for religious freedom. It was a place to start a new life where you wouldn’t be discriminated by your religion.",
      order: 12,
      fontsize: 20,
    },
    {
      setup: "The End!",
      punchline: "Thank you for your time!",
      order: 13,
      fontsize: 20,
    },
  ];
...
Class(function Presentation() {
  ...
  function a() {
    d = e.initClass(PresentationView);
  }
});
Class(function PresentationsPresentation(b) {
  Inherit(this, View);
  var j = this;
  var m, c, e;
  ...
  function g() {
    ...
    m.back
      .size(window.innerWidth - p * 2, window.innerHeight - p * 2)
      .css({
        top: p,
        left: p,
      })
...
Class(function PresentationView() {
  Inherit(this, View);
  var f = this;
  var h, e, n, j;
  var g, k, a;
  ...
  function m() {
    ...
    j.text("The New England Colonies".toUpperCase());
    j.transform({
      y: 20,
    }).tween(
      {
  ...
  function l() {
    ...
    for (var Slide = 0; Slide < Text.Presentation.length; Slide++) {
      if (Text.Presentation[Slide].order === NumberOfTimes) {
        // console.log(Text.Presentation[Slide].fontsize)
        return Text.Presentation[Slide]; // loops through the whole table till it finds the correct one
      } else {
        if (NumberOfTimes == 14) {
          // console.log("hey cunt it's over 14 put it back to one!")
          NumberOfTimes = 1;

          if (Text.Presentation[Slide].order === NumberOfTimes) {
            return Text.Presentation[Slide]; // returns it to the first!
          }
        }
      }
    }
  ...
  function c(o) {
    var p = l();
    k = g;
    g = f.initClass(PresentationsPresentation, p);
